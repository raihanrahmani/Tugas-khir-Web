	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo"> <img src="{{ URL::to('assets/img/logo.png') }}" width="50" height="70" alt="logo"> <span class="logoclass">STUDY ROOM</span> </a>
				<a href="index.html" class="logo logo-small"> <img src="{{ URL::to('assets/img/logo.png') }}" alt="logo" width="30" height="30"> </a>
			</div>
				...
				<li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						<div class="user-header">
							<div class="avatar avatar-sm"> <img src="{{ URL::to('url/https://i.pinimg.com/564x/17/34/9d/17349d29f1eedd45dd372383d76900eb.jpg') }}" alt="User Image" class="avatar-img rounded-circle"> </div>
								<div class="user-text">
									<h6>Soeng Souy</h6>
